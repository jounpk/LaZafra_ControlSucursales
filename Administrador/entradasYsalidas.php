...
END AS button
        ...
        INNER JOIN segusuarios usrio ON ajs.idUserReg = usrio.id WHERE ajs.estatus IN('3', '5', '2') AND ajs.idUserAplica='0'";
    ...
    ORDER BY
            ...
            $(clase).each(function() {
                if ($(this).is(':checked')) {
                    ...
                    if (debug == 1) {
                        ...
                        console.log("CANT ENVIADA: " + cantAAjustar);
                    }
                    if (parseFloat(sumaTotales) < parseFloat(cantAAjustar)) {
        ...
        function revisarCant(idProducto, idLote, valor) {
            ...
            if (parseFloat(cantMaxXLote) < parseFloat(valorAgregado)) {
                $("#lote_" + idLote).val(0);
                ...
                if (parseFloat(cantTotalEnvio) < parseFloat(sumaTotales)) {
