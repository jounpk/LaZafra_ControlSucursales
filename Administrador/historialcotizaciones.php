...
<body>
            ...
            <div class="card border-<?= $pyme; ?>">
              ...
              <div class="card-body">
                <div class="text-right">
                  <a class="btn btn-circle bg-<?= $pyme ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ver Cotizaciones" style=" box-shadow: 7px 10px 12px -4px rgba(0,0,0,0.62); color:#fff" href="cotizaciones.php">
                ...
                <div id="validation" class="m-t-40 jsgrid" style="position: relative; height: auto; width: 100%;">
                  ...
                  <div class="border p-3 mb-3">
                    ...
                    <div class="row">
                      <form method="post" action="historialcotizaciones.php">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <label for="rangeBa1" class="control-label col-form-label">Tipo de Cotizaciones</label>
  ...
  <script>
    ...
    INNER JOIN segusuarios usr ON ct.idUserReg = usr.id 
     WHERE 
     ct.idSucursal='$sucursal'  $filtroTipo $filtroFechas";
    //----------------devBug------------------------------
    if ($debug == 1) {
