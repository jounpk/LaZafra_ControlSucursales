              ...
              <div class="card-body">
                ...
                <div id="validation" class="m-t-40 jsgrid" style="position: relative; height: auto; width: 100%;">
                  ...
                  if (isset($_POST['fechaInicial'])) {
                    ...
                    $filtroFechas = "AND vt.fechaReg BETWEEN '$formFI 00:00:00' AND '$formFF 23:59:59' ";
                  } else {
                    $fechaInicial = "";
                    $filtroFechas = "AND 1=1";
                  }
                  ...
                  if (isset($_POST['buscaDepto']) and $_POST['buscaDepto'] >= 1) {
                    ...
                    $filtroDepto = "AND pro.idDepartamento=" . $_POST['buscaDepto'];
                  } else {
                    $filtroDepto = '';
                    $buscaDepto = '';
                  }
                  ...
                  <div class="border p-3 mb-3">
                    ...
                    <div class="row">
                      <form method="post" action="segprodxsuc.php">
                ...
                <div class="table-responsive">
                    ...
                    <table id="tablaimpresion" class="table" >
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Producto</th>
                    ...
                    FROM
                      ...
                      LEFT JOIN productos pro ON pro.id=stk.idProducto WHERE stk.idSucursal = '$sucursal' GROUP BY pro.id
                      )
                      ...
                      FROM
                        ...
                        AND vt.idSucursal = '$sucursal' 
                        AND vt.estatus = 2
                        WHERE 1=1  $filtroFechas
                        GROUP BY pro.id
