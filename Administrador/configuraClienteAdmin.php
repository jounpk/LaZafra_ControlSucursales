...
<body>
            ...
            #  echo '$tipo: '.$tipo.' $id: '.$id.'<br>';
                ...
                <div class="col-lg-12">
                    <div class="card border-<?=$pyme;?>">
                        ...
                        <br>
                        <div class="card-body">
                            <form action="../funciones/registraNuevoClienteAdmin.php" method="post" id="formCreaCliente" role="form">
                                <div class="form-body">
                                  <div class="row">
             ...
             <!-- ################################################################################################################################################################################################################################## -->
                                           ...
                                           <div class="col-md-12">
                                             <div class="input-group mb-3">
                                               ...
                                               <select class="select2 form-control custom-select" name="newUsoCfdi" id="newUsoCfdi" style="width: 95%; height:100%;">
                                                 ...
                                                 <?php
                                                   $sqlCfdi = "SELECT * FROM usocfdi WHERE estatus = '1' ORDER BY id";
                ...
                <div class="col-lg-12">
                    <div class="card border-<?=$pyme;?>">
                        ...
                        <br>
                        <div class="card-body">
                            <form action="../funciones/editaClienteAdmin.php" method="post" role="form">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                          <div class="input-group mb-3">
    ...
    $(document).ready(function(){
      ...
      #alertMsj($nameLk);
      if (isset( $_SESSION['LZFmsjConfiguraClientesAdmin'])) {
				echo "notificaBad('".$_SESSION['LZFmsjConfiguraClientesAdmin']."');";
				unset($_SESSION['LZFmsjConfiguraClientesAdmin']);
			}
			if (isset( $_SESSION['LZFmsjSuccessConfiguraClientesAdmin'])) {
				echo "notificaSuc('".$_SESSION['LZFmsjSuccessConfiguraClientesAdmin']."');";
        unset($_SESSION['LZFmsjSuccessConfiguraClientesAdmin']);
      }
      ?>
      radioswitch.init()
    });
