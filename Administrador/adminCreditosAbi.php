                       ...
                       <div class="col-md-12">
                         <div class="row">
                           <div class="col-md-4" style="align-items:right;vertical-align: middle;">
                             <div class="col-md-12">
                               <h5 class="m-t-30">Selecciona un rango de Fechas</h5>
                             </div>
                             <div class="col-md-12">
                           ...
                           <div class="col-md-5">
                             <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                   <h5 class="m-t-30">Selecciona un Cliente:</h5>
                                 </div>
                                 <div class="col-md-5">
                                 </div>
                               </div>
                               ...
                               #  echo $sql;
                                 $res=mysqli_query($link,$sql);
                                  while ($rows = mysqli_fetch_array($res)) {
                                    ...
                                    echo '<option value="'.$rows['id'].'" '.$activa.'>'.$rows['nombre'].' ('.$rows['apodo'].')</option>';
                                  }
                                  ?>
                               </select>
                              </div>
                        ...
                        <div id="accordian-3">
                            <?php
                              $sqlCred = "SELECT DATE_FORMAT(pc.fechaReg,'%d/%m/%Y') AS FechaHora,c.*,SUM(pc.monto) AS pago
                                          ...
                                          WHERE c.idCliente = '$cliente' AND pc.fechaReg BETWEEN '$fechaInicial' AND '$fechaFinal' AND v.estatus < '3'
                                          GROUP BY FechaHora
                                ...
                                echo '<div class="card">
                                          ...
                                          <div id="credito'.$idCredito.'-'.$countCred.'" class="collapse" aria-labelledby="heading'.$idCredito.'-'.$countCred.'" data-parent="#accordian-3" style="">
                                              ...
                                              $sqlPagos = "SELECT s.nombre AS nomSucursal, CONCAT(u.nombre, ' ', u.appat, ' ', apmat) AS nomUsuario, pc.*, cm.nombre AS formaPago,pc.fechaReg,c.idVenta, c.estatus AS estatusCredito
                                                          ...
                                                          WHERE c.idCliente = '$cliente' AND DATE_FORMAT(pc.fechaReg,'%d/%m/%Y') = '$fechaReg' AND v.estatus = 2 ORDER BY pc.fechaReg DESC";
                                              #echo $sqlPagos;
                ...
                <div class="row" id="pagoPorCredito" style="display: none;">
                                ...
                                <tbody>
                                  <?php
                                    $sqlPagInd = "SELECT c.idVenta, SUM(pc.monto) AS pagado, c.totalDeuda,pc.fechaReg,c.montoDeudor,
                                                  ...
                                                  INNER JOIN pagoscreditos pc ON c.id = pc.idCredito
                                                  WHERE v.estatus < 4  AND pc.fechaReg BETWEEN '$fechaInicial' AND '$fechaFinal' AND cl.id = '$cliente'
                                                  GROUP BY c.id
                                                  ORDER BY pc.fechaReg DESC";
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                          <div class="card-body">
                            <h4 class="card-title"><b>Créditos Por Pagar</b></h4>
                            <br>
                            <div id="validation" class="m-t-40 jsgrid" style="position: relative; height: auto; width: 100%;">
                              <div class="table-responsive">
                                  ...
                                  <tbody>
                                    <?php
                                      $sqlPend = "SELECT c.*, v.fechaReg,s.nombre, CONCAT(u.nombre,' ', u.appat, ' ',u.apmat) AS nomUsuario, CONCAT(cl.nombre,' (',cl.apodo,')') AS nomCliente,v.id AS idVenta
                                                  ...
                                                  INNER JOIN segusuarios u ON v.idUserReg = u.id
                                                  INNER JOIN clientes cl ON v.idCliente = cl.id
                                                  WHERE c.estatus = 1 $filtroCliente
                                      ...
                                      while ($pend = mysqli_fetch_array($resPend)) {
                                        ...
                                        echo '<tr>
                                                ...
                                                <td class="text-center">'.$pend['montoDeudor'].'</td>
                                                <td>'.$pend['nomUsuario'].'</td>
                                                <td class="text-center">'.$pend['fechaReg'].'</td>
                                                <td class="text-center">
                                                  <button type="button" class="btn btn-info btn-circle muestraSombra" title="Imprimir Ticket" onClick="imprimeTicketVenta('.$pend['idVenta'].');"><i class="fas fa-print"></i></button></button>
                                                </td>
                                              </tr>';
                                      }
                                     ?>
