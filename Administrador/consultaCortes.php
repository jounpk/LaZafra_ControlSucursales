                ...
                <div class="col-md-12">
                  <div class="row">
                    ...
                    <div class="col-md-4" style="align-items:right;vertical-align: middle;">
                      <div class="col-md-12">
                        <h5 class="m-t-30 text-center text-<?= $pyme; ?>">Selecciona el <b>Rango de Fechas</b> que Deseas Consultar</h5>
                      </div>
                      <div class="col-md-12">
              ...
              <div class="card-body">
                ...
                <div class="col-lg-12">
                  <div id="accordian-3">
                    ...
                    $sql = "SELECT DATE_FORMAT(c.fechaCierre, '%Y-%m-%d') AS fechaDeCierre, c.idSucursal,DATE_FORMAT(c.fechaCierre, '%d-%m-%Y') AS fechaDeCierre2
                            FROM cortes c
                            WHERE c.estatus = 2 AND c.idSucursal = '$idSucursal' AND (DATE_FORMAT(c.fechaCierre,'%Y-%m-%d') BETWEEN '$fechaInicial' AND '$fechaFinal')
                    ...
                    while ($crt = mysqli_fetch_array($resultXquery)) {
                      ++$no;
                      ...
                      $sql = "SELECT c.id,scs.nombre, CONCAT(u.nombre,' ',u.appat,' ',u.apmat) AS nomUsuario
                       FROM cortes c
                       INNER JOIN segusuarios u ON c.idUserReg = u.id
                       INNER JOIN sucursales scs ON c.idSucursal = scs.id
                       LEFT JOIN desglocesefectivo df ON c.id = df.idCorte
                       WHERE DATE_FORMAT(c.fechaCierre, '%Y-%m-%d') = '$fechaCorte' AND c.estatus = '2' AND c.idSucursal = '$idSucursal'
                       ORDER BY c.id ASC";
                    ...
                    if ($debug == 1) {
                      ...
                      mysqli_data_seek($resultXquery, 0);
                      while ($rows = mysqli_fetch_array($resultXquery)) {
                        ++$no3;
                        $idCorte2 = $rows['id'];
                        if ($no3 == 1) {
                          $activo2 = 'active';
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header bg-<?= $pyme ?>">
                <h4 class="modal-title" class="text-white" id="lblFacturaVenta">Ticket No.: </h4>
      ...
      if (idVenta > 0) {
        ...
        $.post("../funciones/formularioFacturacion.php", {
          ...
          function(respuesta) {
            ...
            $("#lblFacturaVenta").addClass("text-white");
