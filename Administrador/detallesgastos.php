          ...
          <div class="col-md-12 col-lg-12">
            <div class="card border-<?= $pyme; ?>">
              ...
              <div class="card-body">
                ...
                <a class="btn btn-circle bg-<?=$pyme?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ver Pagos" style=" box-shadow: 7px 10px 12px -4px rgba(0,0,0,0.62); color:#fff" href="gastosYpagos.php">
                ...
                <div id="validation" class="m-t-40 jsgrid" style="position: relative; height: auto; width: 100%;">
                  ...
                  <div class="row">
                    <form method="post" action="detallesgastos.php">
                ...
                <div class="table-responsive">
                  <table class="table product-overview table-striped" id="zero_config">
                    ...
                    <tbody>
                      ...
                      $sqlgstos = "SELECT gstos.*, IF(idCorte!=0, idCorte, 'Sin Corte Registrado') AS corte  FROM gastos gstos WHERE idSucursal='$idSucursal'  $filtroFechas ORDER BY fechaReg DESC";
                     // echo $sqlgastos;
