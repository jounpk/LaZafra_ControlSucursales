...
$sql="UPDATE productos SET fichaTecnica='' WHERE id='$ident'";


//----------------devBug------------------------------
if ($debug == 1) {
  $resultXquery=mysqli_query($link,$sql) or die(errorBD('Problemas al Eliminar Ficha Tecnica, notifica a tu Administrador', mysqli_error($link)));
