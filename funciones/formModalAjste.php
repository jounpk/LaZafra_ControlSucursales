...
switch ($estado_solicitud) {
    ...
    break;
    case '2':
    require_once('cargaAjstModalEspera.php');
    ...
    <button type='button' onclick=\"ajustar();\" class=\"btn btn-success\">Ajustar</button>
    
    
    
    ";

    $modal_completo.=$cabecera_modal.$body_modal.$detalles.$alerta.$estTabla."</div></form></div>";
    break;
}
echo $modal_completo;
?>
