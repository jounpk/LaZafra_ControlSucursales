...
if ($regresar == 1) {
  $_SESSION['LZFmsjSuccessAdminClientes'] = 'El Cliente '.$nombre.' se ha registrado correctamente';
  header('location: ../Administrador/clientes.php');
} else {
  $_SESSION['LZFmsjSuccessConfiguraClientesAdmin'] = 'El Cliente '.$nombre.' se ha registrado correctamente';
  header('location: ../Administrador/configuraClienteAdmin.php');
}
exit(0);

function errorDatosFisc($error,$regresar){
  if ($regresar == 1) {
    $_SESSION['LZFmsjSuccessAdminClientes'] = 'El Cliente '.$nombre.' se ha registrado correctamente'.$error;
    header('location: ../Administrador/clientes.php');
  } else {
    $_SESSION['LZFmsjSuccessConfiguraClientesAdmin'] = 'El Cliente '.$nombre.' se ha registrado correctamente'.$error;
    header('location: ../Administrador/configuraClienteAdmin.php');
  }
}
...
function errorBD($error,$regresar){
  ...
  #  echo '<br> error';
  if ($regresar == 1) {
    $_SESSION['LZFmsjAdminClientes'] = $error;
    header('location: ../Administrador/clientes.php');
  } else {
    $_SESSION['LZFmsjConfiguraClientesAdmin'] = $error;
    header('location: ../Administrador/configuraClienteAdmin.php');
  }
  exit(0);
}
