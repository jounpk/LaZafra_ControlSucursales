        ...
        "columns": [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                   boton=' <center><button type="button" class="btn bg-success btn-circle muestraSombra" onClick="muestraTicket('+data.id+')"><i class="fas fa-print text-white"></i></button></center>';
                    return boton;
                }}
