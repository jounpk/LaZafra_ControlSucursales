                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="finVig1"><i class="far fa-calendar-alt"></i></span>
                                    <input class="datepicker form-control" autocomplete="off" type="text" value="<?= $fechaInicial ?>" id="rangeBa1" name="fechaInicial" />
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="finVig1"><i class="far fa-calendar-alt"></i></span>
                                    <input class="datepicker form-control" autocomplete="off" type="text" value="<?= $fechaFinal ?>" id="rangeBa2" name="fechaFinal" />
                    ...
                    <table id="tablaimpresion" class="table table-bordered footer_callback" data-toggle-column="first">
                      <thead>
                        <tr>
                          ...
                          <?php
                          $sqlSuc = "SELECT nameFact AS nombre, id FROM sucursales ORDER BY nombre";
                  ...
                  ORDER BY
                    vnta.cantVenta DESC";
                       //echo 'Productos --->'.$sqlProductos."<br>";
                        ...
                        scs.nameFact 
                        )ORDER BY scs.nameFact) AS query FROM sucursales scs";
                        // echo "<br>".$sqlQuery;
