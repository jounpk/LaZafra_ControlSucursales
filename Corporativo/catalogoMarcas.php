...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-md-8 col-lg-8">
                    <div class="card border-<?=$pyme;?>">
                      <div class="card-header bg-<?=$pyme;?>">
                        <h4 class="m-b-0 text-white">Listado de Marcas</h4>
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-md-4 col-lg-4">
                    <div class="card border-<?=$pyme;?>">
                      <div class="card-header bg-<?=$pyme;?>">
                        <h4 class="m-b-0 text-white">Ingreso de una Nueva Marca</h4>
                      </div>
                      <div class="card-body">
                            <form role="form" id="formNewMarca">
                              <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-trademark"></i></span>
                                    </div>
                                    <input type="text" class="form-control" placeholder="Ingresa una Nueva Marca" id="nombreMarca" name="nombreMarca" oninput="limpiaCadena(this.value,'nombreMarca');" aria-label="Username" aria-describedby="basic-addon1" required>
                                </div>
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <div id="desbloquear-btn">
                                      ...
                                      <button type="button" class="btn btn-success waves-effect waves-light" onclick="crearMarca('bloquear-btn');">Capturar</button>
                                    </div>
                                  </div>
                              </form>
                      </div>
                ...
                <div id="modalEditMarca" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" enctype="multipart/form-data">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="lblEditMarca">Editar</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body">
                              <form role="form" id="formEditaMarca">

                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="eNombre1"><i class="far fa-envelope"></i></span>
                                        </div>
                                        <input type="text" class="form-control" id="eNombre" placeholder="Ingresa el Nombre de la Marca" aria-describedby="nombre" name="eNombre" oninput="limpiaCadena(this.value,'eNombre');" required>
                                    </div>
    ...
    #  alertMsj($nameLk);
			if (isset( $_SESSION['LZFmsjCatalogoMarcas'])) {
				echo "notificaBad('".$_SESSION['LZFmsjCatalogoMarcas']."');";
				unset($_SESSION['LZFmsjCatalogoMarcas']);
			}
			if (isset( $_SESSION['LZFmsjSuccessCatalogoMarcas'])) {
				echo "notificaSuc('".$_SESSION['LZFmsjSuccessCatalogoMarcas']."');";
        unset($_SESSION['LZFmsjSuccessCatalogoMarcas']);
			}
			?>

    }); // Cierre de document ready

    function crearMarca(boton){
      var nombre = $("#nombreMarca").val();
      if (nombre != '') {
      bloqueoBtn(boton,1);
      $.post("../funciones/registraNuevaMarca.php",
      {nombre:nombre},
      function(respuesta){
    ...
    function mandaEdición(boton){
      ...
      if (nombre != '') {
        bloqueoBtn(boton,1);
        $.post("../funciones/editaMarca.php",
      {idMarca:id, nombre:nombre},
    function(respuesta){
      var resp = respuesta.split('|');
      if (resp[0] == 1) {
        listaMarcas();
    ...
    function mandaModal(id){
      if (id > 0) {
      var nombre = $("#nombreMarca-"+id).html();
      $("#lblEditMarca").html('Editar '+nombre);
      $("#eNombre").val(nombre);
      $("#idMarca").val(id);
    }
  }
    ...
    function cambiaEstatus(id,estatus){
      if (id > 0 && estatus > 0) {
        $.post("../funciones/cambiaEstatusDeMarca.php",
      {idMarca:id, estatus:estatus},
    function(respuesta){
      var resp = respuesta.split('|');
      if (resp[0] == 1) {
        notificaSuc(resp[1]);
        if (estatus == 1) {
          $("#estatusMarca-"+id).html(resp[3]);
      ...
      notificaBad('No se reconoció la Marca, actualiza y vuelve a intentarlo, si persiste notifica a tu Administrador');
      }
    }

    function listaMarcas(){
    //  var mensaje = 'Mensaje';
      $.post("../funciones/listarMarcas.php",
    {},
  function(respuesta){
