                            ...
                            <div class="table-responsive">
                              <table class="table table-striped table-bordered dataTable" id="zero_config">
                                ...
                                <tbody>
                                  <?php
                                  #/*
                                    $sqlPend = "SELECT v.id, scs.nombre AS nomSucursal, CONCAT(u.nombre,' ',u.appat,' ',u.apmat) AS nomUsuario,
                                    ...
                                    while ($pend = mysqli_fetch_array($resPend)) {
                                      ...
                                      echo '<tr>
                                              <td class="text-center">'.$pend['id'].'</td>
                                              <td>'.$pend['nomSucursal'].'</td>
                                              <td>'.$pend['nomUsuario'].'</td>
                                              <td>'.$pend['motivoVtaEsp'].'</td>
                                              <td>'.$pend['nomCliente'].'</td>
                                              <td class="text-center">'.$pend['fecha'].'</td>
                                              <td class="text-center" id="btnAutorizacion">
                                                <button type="button" class="btn btn-success btn-circle muestraSombra" title="Aceptar Solicitud" onClick="aceptaVentaEsp('.$pend['id'].',1);"><i class="fas fa-check"></i></button>
                                                <button type="button" class="btn btn-danger btn-circle muestraSombra" title="Rechazar Solicitud" onClick="aceptaVentaEsp('.$pend['id'].',2);"><i class="fas fa-times"></i></button>
                                              </td>
                                            </tr>';
                                    }
                                    #*/
