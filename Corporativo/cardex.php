                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control custom-select" name="buscaMov" id="buscaMov" onchange="">
                                                                <?php switch ($buscaMov) {
                                                                    ...
                                                                    <option value="2">Recepciones</option>
                                                                    ...
                                                                    case '2':
                                                                        echo ' <option value="">Todos</option>
                                                                                ...
                                                                                <option value="3"> Devoluciones</option>
                                                                                <option value="4"> Ediciones de Stock</option>
                                                                                <option value="2" selected>Recepciones</option>
                                    ...
                                    $sql = "SELECT * FROM (
                                      ...
                                      AND $buscaSuc
                                       ...
                                       UNION
                                        ...
                                        0 AS cancelada,
                                        CONCAT( us.nombre, ' ', us.appat ) AS usuario,
                                        CONCAT( 'reimprimeTickets.php?idVenta=', rp.id, '&tipoTicket=lanzaTraspaso' ) AS urlTicket,
