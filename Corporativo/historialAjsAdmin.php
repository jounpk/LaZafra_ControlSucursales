...
<body>
          ...
          <div class="col-md-12 col-lg-12">
            <div class="card border-<?= $pyme; ?>">
              <div class="card-header bg-<?= $pyme; ?>">
                <h4 class="m-b-0 text-white">Listado de Ajustes</h4>
              </div>
              <div class="card-body">

                <div class="text-right">
                  <a class="btn btn-circle bg-<?= $pyme; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Autorización de Ajustes" style=" box-shadow: 7px 10px 12px -4px rgba(0,0,0,0.62); color:#fff" href="solicitudEntradasSalidas.php"> <i class="mdi mdi-clipboard-flow"></i></a>
                ...
                <div class="row">
                  <form method="post" action="historialAjsAdmin.php">
  ...
  <script src="../assets/tablasZafra/datatable_ajsteHistorial.js"></script>
...
FROM
  ...
  WHERE ajs.estatus!='2'
  AND $filtroFechas AND $filtroSuc ORDER BY ajs.fechaReg";
