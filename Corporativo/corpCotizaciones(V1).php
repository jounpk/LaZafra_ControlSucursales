                                ...
                                <tbody>
                                  ...
                                  $no = 0;
                                     while ($pend = mysqli_fetch_array($resPendientes)) {
                                       ...
                                       $btnAcciones = '
                                       <a href="../funciones/imprimeTicketCotizacion.php?idCotizacion='.$idCotizacion.'" target="_blank" class="btn btn-outline-success btn-square btn-sm muestraSombra" title="Imprimir Ticket"><i class="fas fa-file-alt"></i></a>
                                      ...
                                      while ($d = mysqli_fetch_array($resHistorial)) {
                                        ...
                                        switch ($d['estatus']) {
                                          case '2':
                                            ...
                                            $color = '';
                                            $btnAccion = '
                                                          <a href="../funciones/imprimeTicketCotizacion.php?idCotizacion='.$d['id'].'" target="_blank" class="btn btn-outline-success btn-square btn-sm" title="Imprimir Ticket"><i class="fas fa-file-alt"></i></a>
                                          ...
                                          case '3':
                                            ...
                                            $btnAccion = '
                                                          ...
                                                          <a href="../funciones/imprimeTicketCotizacion.php?idCotizacion='.$d['id'].'" target="_blank" class="btn btn-outline-success btn-square btn-sm muestraSombra2" title="Imprimir Ticket"><i class="fas fa-file-alt"></i></a>
