                  ...
                  <div class="col-lg-12">
                      ...
                      <div class="card-body">
                        ...
                        if (isset($_POST['sucursal']) && $_POST['sucursal'] > 0 ) {
                          ...
                          $filtroSucursal = " AND v.idSucursal = '$sucursal'";
                        } else{
                          $sucursal = '';
                          $filtroSucursal = '';
                        }
                       ...
                       <div class="col-md-12">
                         ...
                         <div class="col-md-4">
                           <div class="col-md-12">
                               ...
                               <div class="col-md-12">
                                 <h5 class="m-t-30 text-<?=$pyme;?>">Filtrar por Sucursal:</h5>
                               </div>
                               <div class="col-md-5">
                               </div>
                             </div>
                           ...
                           <div class="col-md-8">
                             <select class="select2 form-control custom-select" name="sucursal" id="sucursal" style="width: 95%; height:100%;">
                               ...
                               <?php
                                $sqlConSuc = "SELECT id,nombre FROM sucursales WHERE estatus = 1";
                                $resConSuc = mysqli_query($link,$sqlConSuc) or die('Problemas al consutlar las sucursales, notifica a tu Administrador.');

                                while ($sc = mysqli_fetch_array($resConSuc)) {
                                  $activa = ($sucursal == $sc['id']) ? 'selected' : '' ;
                                  echo '<option value="'.$sc['id'].'" '.$activa.'>'.$sc['nombre'].'</option>';
                                }
                                ?>
                             </select>
                           </div>
                        ...
                        <div id="validation" class="m-t-40 jsgrid" style="position: relative; height: auto; width: 100%;">
                          <div class="table-responsive">
                            <table class="table product-overview" id="zero_config">
                              ...
                              <tbody>
                                <?php
                                  $sqlDev = "SELECT dv.idVenta, p.descripcion AS nomProducto, d.cantidad AS cantDevuelto, d.motivo, d.fechaReg, CONCAT(u.nombre,' ',u.appat,' ',u.apmat) AS nomUsuario, s.nombre AS nomSucursal
                                            FROM devoluciones d
                                            ...
                                            INNER JOIN sucursales s ON d.idSucursal = s.id
                                            WHERE d.fechaReg BETWEEN '$fechaInicial' AND '$fechaFinal' AND v.estatus = '2'  $filtroSucursal
                          ...
                          <div class="table-responsive">
                            <table class="table product-overview" id="zero_config2">
                              ...
                              <tbody>
                                <?php
                                #  /*
                                $sqlCancel = "SELECT c.idVenta,c.motivo, c.fecha, CONCAT(u.nombre,' ',u.appat,' ',u.apmat) AS nomUsuario, s.nombre AS nomSucursal
                                          ...
                                          WHERE c.fecha BETWEEN '$fechaInicial' AND '$fechaFinal' AND v.estatus = 3  $filtroSucursal
                          ...
                          <div class="table-responsive">
                            <table class="table product-overview" id="zero_config3">
                              ...
                              <tbody>
                                <?php
                                #  /*
                                $sqlAll = "SELECT a.idVenta, a.cant, a.motivo,a.tipo, a.fechaReg, a.nomUsuario
                                              FROM ventas v
                                              INNER JOIN (
                                              ...
                                              WHERE a.fechaReg BETWEEN '$fechaInicial' AND '$fechaFinal' $filtroSucursal
                                              ORDER BY a.fechaReg DESC";
                                              #echo '$sqlAll: '.$sqlAll;
                                $resCancel = mysqli_query($link,$sqlAll) or die('Problemas al consultar las devoluciones, notifica a tu Administrador.');
